...
Partial Public Class ERS_PagesByRole
    Public Property PagesByRoleId As Integer
    Public Property RoleId As Integer
    Public Property PageId As Short
    Public Property AccessLevel As Nullable(Of Byte)
