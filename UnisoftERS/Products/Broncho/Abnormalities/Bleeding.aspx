<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Bleeding.aspx.vb" Inherits="UnisoftERS.Bleeding" %>
...
<head runat="server">
    ...
    <telerik:RadScriptBlock runat="server" ID="RadCodeBlock">
        <script type="text/javascript">
            var bleedingValueChanged = false;
...
<body>
    <form id="form2" runat="server">
        ...
        <div class="abnorHeader">
            <asp:Label ID="HeadingLabel" runat="server" Text="Bleeding"></asp:Label></div>
