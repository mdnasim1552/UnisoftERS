<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ExcessiveSecretions.aspx.vb" Inherits="UnisoftERS.ExcessiveSecretions" %>
...
<head runat="server">
    ...
    <telerik:RadScriptBlock runat="server" ID="RadCodeBlock">
        <script type="text/javascript">
            var excessiveSecretionsValueChanged = false;
            ...
            $(document).ready(function () {
                $("#BRTAbnosTable tr td:first-child input:checkbox, input:radio").change(function () {
                    ToggleTRs($(this));
                    excessiveSecretionsValueChanged = true;
                });
                ...
                $(window).on('beforeunload', function () {
                    if (excessiveSecretionsValueChanged) {
...
<body>
    <form id="form2" runat="server">
        ...
        <ContentTemplate>
        <div class="abnorHeader"><asp:Label ID="HeadingLabel" runat="server" Text="Excessive Secretions"></asp:Label></div>
