...
Public Class MucosalIrregularity
    ...
    Private Sub PopulateData(drSc As DataRow)
        If Not IsDBNull(drSc("MucosalIrregularity")) AndAlso CInt(drSc("MucosalIrregularity")) > 0 Then
            MucosalIrregularityRBL.SelectedValue = CInt(drSc("MucosalIrregularity"))
    ...
    Protected Sub SaveRecord(saveAndClose As Boolean)
        Try
            ...
            AbnormalitiesDataAdapter.SaveBRTAbnosData(
                ...
                Nothing,
                Nothing,
                Utilities.GetRadioValue(MucosalIrregularityRBL),
                Nothing,
                Nothing)
            ...
            Using db As New ERS.Data.GastroDbEntities
                ...
                ersRecord = db.ERS_RecordCount.Where(Function(ers) ers.SiteId = siteId And ers.Identifier = "Mucosal Irregularity").FirstOrDefault()
                ...
                If ersRecord Is Nothing Then
                    ...
                    ersRecord.Identifier = "Mucosal Irregularity"
        ...
        Catch ex As Exception
            ...
            errorLogRef = LogManager.LogManagerInstance.LogError("Error occured while saving Bronchoscopy/EBUS Abnormalities - Mucosal Irregularity.", ex)
