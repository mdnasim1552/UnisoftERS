...
Public Class Obstruction
    ...
    Private Sub PopulateData(drSc As DataRow)
        If Not IsDBNull(drSc("Obstruction")) AndAlso CInt(drSc("Obstruction")) > 0 Then
            ObstructionRBL.SelectedValue = CInt(drSc("Obstruction"))
    ...
    Protected Sub SaveRecord(saveAndClose As Boolean)
        Try
            ...
            AbnormalitiesDataAdapter.SaveBRTAbnosData(
                ...
                Nothing,
                Nothing,
                Utilities.GetRadioValue(ObstructionRBL),
                Nothing,
                Nothing,
                Nothing,
                Nothing,
            ...
            Using db As New ERS.Data.GastroDbEntities
                ...
                ersRecord = db.ERS_RecordCount.Where(Function(ers) ers.SiteId = siteId And ers.Identifier = "Obstruction").FirstOrDefault()
                ...
                If ersRecord Is Nothing Then
                    ...
                    ersRecord.Identifier = "Obstruction"
        ...
        Catch ex As Exception
            ...
            errorLogRef = LogManager.LogManagerInstance.LogError("Error occured while saving Bronchoscopy/EBUS Abnormalities - Obstruction.", ex)
