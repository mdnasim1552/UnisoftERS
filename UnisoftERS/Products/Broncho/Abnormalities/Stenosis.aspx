<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Stenosis.aspx.vb" Inherits="UnisoftERS.Stenosis" %>
...
<head runat="server">
    ...
    <telerik:RadScriptBlock runat="server" ID="RadCodeBlock">
        <script type="text/javascript">
            var stenosisValueChanged = false;
...
<body>
    <form id="form2" runat="server">
        ...
        <div class="abnorHeader">
            <asp:Label ID="HeadingLabel" runat="server" Text="Stenosis"></asp:Label></div>
