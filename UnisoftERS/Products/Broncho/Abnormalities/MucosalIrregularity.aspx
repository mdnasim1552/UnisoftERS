<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="MucosalIrregularity.aspx.vb" Inherits="UnisoftERS.MucosalIrregularity" %>
...
<head runat="server">
    ...
    <telerik:RadScriptBlock runat="server" ID="RadCodeBlock">
        <script type="text/javascript">
            var mucosalIrregularityValueChanged = false;
            ...
            $(document).ready(function () {
                $("#BRTAbnosTable tr td:first-child input:checkbox, input:radio").change(function () {
                    ToggleTRs($(this));
                    mucosalIrregularityValueChanged = true;
                });
                ...
                $(window).on('beforeunload', function () {
                    if (mucosalIrregularityValueChanged) {
...
<body>
    <form id="form2" runat="server">
        ...
        <ContentTemplate>
        <div class="abnorHeader"><asp:Label ID="HeadingLabel" runat="server" Text="Mucosal Irregularity"></asp:Label></div>
