<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="VocalCordParalysis.aspx.vb" Inherits="UnisoftERS.VocalCordParalysis" %>
...
<body>
    <form id="form2" runat="server">
        ...
        <div class="abnorHeader">
            <asp:Label ID="HeadingLabel" runat="server" Text="Vocal Cord Paralysis"></asp:Label></div>
