<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="CarinalAbnormality.aspx.vb" Inherits="UnisoftERS.CarinalAbnormality" %>
...
<head runat="server">
    ...
    <telerik:RadScriptBlock runat="server" ID="RadCodeBlock">
        <script type="text/javascript">
            var carinalAbnormalityValueChanged = false;
            ...
            $(document).ready(function () {
                $("#BRTAbnosTable tr td:first-child input:checkbox, input:radio").change(function () {
                    ToggleTRs($(this));
                    carinalAbnormalityValueChanged = true;
                });
                ...
                $(window).on('beforeunload', function () {
                    if (carinalAbnormalityValueChanged) {
...
<body>
    <form id="form2" runat="server">
        ...
        <div class="abnorHeader">
            <asp:Label ID="HeadingLabel" runat="server" Text="Carinal Abnormality"></asp:Label></div>
