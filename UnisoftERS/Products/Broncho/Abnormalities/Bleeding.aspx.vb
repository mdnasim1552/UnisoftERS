...
Public Class Bleeding
    ...
    Private Sub PopulateData(drSc As DataRow)
        If Not IsDBNull(drSc("Bleeding")) AndAlso CInt(drSc("Bleeding")) > 0 Then
            BleedingRBL.SelectedValue = CInt(drSc("Bleeding"))
    ...
    Protected Sub SaveRecord(saveAndClose As Boolean)
        Try
            ...
            Using db As New ERS.Data.GastroDbEntities
                ...
                ersRecord = db.ERS_RecordCount.Where(Function(ers) ers.SiteId = siteId And ers.Identifier = "Bleeding").FirstOrDefault()
        ...
        Catch ex As Exception
            ...
            errorLogRef = LogManager.LogManagerInstance.LogError("Error occurred while saving Bronchoscopy/EBUS Abnormalities - Bleeding.", ex)
