...
<%--            <h4>Works in progress!!!</h4>--%>
            <%--<h4>Analysis for <%=GetValue("SELECT Consultant FROM v_rep_Consultants A, ERS_ReportConsultants B WHERE A.ReportID = B.ConsultantID And B.UserID=" + Session("PKUserID").ToString + " And B.AnonimizedID=" + Request.QueryString("rowID"))%></h4>--%>
...
<%--            <p>Group: <%=Request.QueryString("Group")%></p>
            ...
            <p>
                <telerik:RadGrid ID="GridView1" runat="server" AllowPaging="False" Skin="Office2010Blue" DataSourceID="DSPopUp">
                </telerik:RadGrid>
            ...
            <asp:ObjectDataSource ID="DSPopUp" runat="server" SelectMethod="GetPopUpRows" TypeName="UnisoftERS.PopUp">
                <SelectParameters>
                    ...
                    <asp:QueryStringParameter Name="anonimizedId" QueryStringField="anonimizedId" Type="Int32" />
                    <asp:QueryStringParameter Name="columnName" QueryStringField="columnName" Type="String" />
                    <asp:QueryStringParameter Name="procedureTypeId" QueryStringField="procedureTypeId" Type="Int32" />
                </SelectParameters>
