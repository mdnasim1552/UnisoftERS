<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ListAnalysis2.aspx.vb" Inherits="UnisoftERS.ListAnalysis2" %>
...
<body>
    ...
    <div id="ReportContainer">
        ...
        <rsweb:ReportViewer ID="RV" runat="server" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" SizeToReportContent="true" CssClass="RVcss" KeepSessionAlive="False" >
            <LocalReport ReportEmbeddedResource="UnisoftERS.ListAnalysis2.rdlc">
            </LocalReport>
        </rsweb:ReportViewer>
