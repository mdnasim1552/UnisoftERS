...
Public Class ListAnalysis5
    ...
    Protected Sub Page_Tnit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Init
        ...
        If Not Page.IsPostBack Then
            ...
            localReport.ReportPath = "Products/Reports/RV/listAnalysis5.rdlc"
            ...
            localReport.SetParameters(New ReportParameter() {p0})

            Dim ds1 As New DataSet()
            ds1 = Reports.GetListAnalysis5(UserID)
