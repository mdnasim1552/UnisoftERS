<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ListAnalysis5.aspx.vb" Inherits="UnisoftERS.ListAnalysis5" %>
...
<body>
    ...
    <div id="ReportContainer" runat="server">
        ...
        <rsweb:ReportViewer ID="RV" runat="server" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" SizeToReportContent="true" CssClass="RVcss" KeepSessionAlive="False" >
            <LocalReport ReportEmbeddedResource="UnisoftERS.ListAnalysis5.rdlc">
            </LocalReport>
        </rsweb:ReportViewer>
