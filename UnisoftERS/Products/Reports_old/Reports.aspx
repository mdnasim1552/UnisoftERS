<%@ Page Title="" Language="VB" MasterPageFile="~/Templates/Unisoft.Master" AutoEventWireup="false" Inherits="UnisoftERS.Products_Reports_Report" Codebehind="Reports.aspx.vb" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="LeftPaneContentPlaceHolder" runat="server">
    <div class="tabsContainer">
        <telerik:RadTabStrip ID="RadTabStrip1" runat="server" MultiPageID="MainMultiPage" Skin="WebBlue" AutoPostBack="true" OnTabClick="RadTabStrip1_TabClick1">
            <Tabs>
                <telerik:RadTab runat="server" Text="GRS" Selected="true"  PageViewID="GRSPageView"/>
                <telerik:RadTab runat="server" Text="JAGGRS" PageViewID="JAGGRSPageView"/>
            </Tabs>
        </telerik:RadTabStrip>
    </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="BodyContentPlaceHolder" runat="server">
    ...
    <div id="rside" runat="server">
        <telerik:RadMultiPage ID="MainMultiPage" Runat="server" SelectedIndex="0" Height="650px">
                                                    ...
                                                    <table id="FilterConsultant" class="checkboxesTable">
                                                        <tr>
                                                            ...
                                                            <td  style="text-align:right;">
                                                                <telerik:RadComboBox ID="ComboConsultants" runat="server">
                                                                    <Items>
                                            ...
                                            <asp:Panel ID="MiniFilterPanel" runat="server">
                                                <div class="secret" id="RTSP">
                                                    <telerik:RadTabStrip ID="RadTabStripParameters" runat="server" MultiPageID="RadMultiPageParameters" SelectedIndex="0" Skin="WebBlue">
                                                        <Tabs>
                                                            <telerik:RadTab runat="server" Text="GRS A-1" PageViewID="GRSA01PV">
                                                            </telerik:RadTab>
                                                            <telerik:RadTab runat="server" Text="GRS A-2" PageViewID="GRSA02PV">
                                                            </telerik:RadTab>
                                                            <telerik:RadTab runat="server" Text="GRS A-3" PageViewID="GRSA03PV">
                                                            </telerik:RadTab>
                                                            <telerik:RadTab runat="server" Text="GRS A-4" PageViewID="GRSA04PV">
                                                            </telerik:RadTab>
                                                            <telerik:RadTab runat="server" Text="GRS A-5" PageViewID="GRSA05PV">
                                                            </telerik:RadTab>
                                                            <telerik:RadTab runat="server" Text="GRS B-1" PageViewID="GRSB01PV">
                                                            </telerik:RadTab>
                                                            <telerik:RadTab runat="server" Text="GRS B-2" PageViewID="GRSB02PV">
                                                            </telerik:RadTab>
                                                            <telerik:RadTab runat="server" Text="GRS B-3" PageViewID="GRSB03PV">
                                                            </telerik:RadTab>
                                                            <telerik:RadTab runat="server" Text="GRS B-4" PageViewID="GRSB04PV">
                                                            </telerik:RadTab>
                                                            <telerik:RadTab runat="server" Text="GRS B-5" PageViewID="GRSB05PV">
                                                            </telerik:RadTab>
                                                            <telerik:RadTab runat="server" Text="GRS C-1" PageViewID="GRSC01PV">
                                                            </telerik:RadTab>
                                                            <telerik:RadTab runat="server" Text="GRS C-2" PageViewID="GRSC02PV">
                                                            </telerik:RadTab>
                                                            <telerik:RadTab runat="server" Text="GRS C-3" PageViewID="GRSC03PV">
                                                            </telerik:RadTab>
                                                            <telerik:RadTab runat="server" Text="GRS C-4" PageViewID="GRSC04PV">
                                                            </telerik:RadTab>
                                                            <telerik:RadTab runat="server" Text="GRS C-5" PageViewID="GRSC05PV">
                                                            </telerik:RadTab>
                                                            <telerik:RadTab runat="server" Text="GRS C-6" PageViewID="GRSC06PV">
                                                            </telerik:RadTab>
                                                            <telerik:RadTab runat="server" Text="GRS C-7" PageViewID="GRSC07PV">
                                                            </telerik:RadTab>
                                                            <telerik:RadTab runat="server" Text="GRS C-8" PageViewID="GRSC08PV">
                                                            </telerik:RadTab>
                                                        </Tabs>
                                                    </telerik:RadTabStrip>
                                                </div>
            ...
            <telerik:RadPageView runat="server" ID="JAGGRSPageView" Height="700px">
                <div class="">
