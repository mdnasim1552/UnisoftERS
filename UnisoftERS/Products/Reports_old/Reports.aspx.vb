...
Public Class Products_Reports_Report
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Session("isERSViewer") Is Nothing Or Session("isERSViewer") Then
    ...
    Private Sub LoadTreeView()
        'Dim array1() As String = {"JAG/GRS Reports", "Audit Log", "Patient", "Procedure", "Operator", "GRS", "GRS A", "GRS B", "GRS C", "GRS reports"}
        'Dim array2() As String = {"GRSA01", "GRSA02", "GRSA03", "GRSA04", "GRSA05", "GRSB01", "GRSB02", "GRSB03", "GRSB04", "GRSB05", "GRCB01", "GRCB02", "GRCB03", "GRCB04", "GRCB05", "GRCB06", "GRCB07", "GRCB08"}
        Dim str As String = ""
        ...
        Dim reader As New System.Xml.XmlTextReader(Server.MapPath("~/App_Data/Menus/ReportsMenu.xml"))
        While reader.Read()
