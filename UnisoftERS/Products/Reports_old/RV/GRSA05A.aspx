<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="GRSA05A.aspx.vb" Inherits="UnisoftERS.GRSA05A" %>
...
<body>
    ...
    <div id="ReportContainer">
        ...
        <rsweb:ReportViewer ID="RV" runat="server" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" SizeToReportContent="true" CssClass="RVcss" >
            <LocalReport ReportEmbeddedResource="UnisoftERS.GRSA05A.rdlc">
            </LocalReport>
        </rsweb:ReportViewer>    
