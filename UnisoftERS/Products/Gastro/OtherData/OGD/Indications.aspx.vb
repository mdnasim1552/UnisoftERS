...
Partial Class Products_Gastro_OtherData_OGD_Indications
    ...
    Protected Sub Display()
        ...
        ElseIf procType = ProcedureType.Gastroscopy Or procType = ProcedureType.EUS_OGD Or procType = ProcedureType.Transnasal Then
    ...
    Sub ExitForm()
        Try
            ...
            'If (AntiCoagRadioButtonList.SelectedValue = 1 Or ColonAntiCoagRadioButtonList.SelectedValue = 1) And Not IsRxComplete() Then
            'Response.Clear()
