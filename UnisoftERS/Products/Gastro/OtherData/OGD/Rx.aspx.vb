...
Partial Class Products_Gastro_OtherData_OGD_RX
    Inherits PageBase
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        myAjaxMgr.AjaxSettings.AddAjaxSetting(SaveButton, MedicationText, RadAjaxLoadingPanel1)
        myAjaxMgr.AjaxSettings.AddAjaxSetting(SaveButton, RadNotification1)
        myAjaxMgr.AjaxSettings.AddAjaxSetting(CancelButton, MedicationText, RadAjaxLoadingPanel1)
    End Sub
    ...
    Private Sub PopulateData(dtRx As DataRow)
        ...
        End If
        MedicationText.Text = Server.HtmlDecode(CStr(dtRx("MedicationText")))
    End Sub
