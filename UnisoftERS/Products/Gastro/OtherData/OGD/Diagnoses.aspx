<%@ Page Language="VB" MasterPageFile="~/Templates/ProcedureMaster.Master" AutoEventWireup="false" Inherits="UnisoftERS.Products_Gastro_OtherData_OGD_Diagnoses" CodeBehind="Diagnoses.aspx.vb" ValidateRequest="false" %>
    ...
    <telerik:RadScriptBlock runat="server">
        <script type="text/javascript">
            ...
            <% If procTypeID = 1 Then%>
                if (!OesophagusTab() && !$("#<%= OverallNormalCheckBox.ClientID%>").is(":checked")) {
                    //$("[name*='OesophagusNormalCheckBox']").prop('checked', true);
                }
                if (!StomachTab() && !$("#<%= OverallNormalCheckBox.ClientID%>").is(":checked")) {
                    //$("[name*='StomachNormalCheckBox']").prop('checked', true);
                }
                if (!DuodenumTab() && !$("#<%= OverallNormalCheckBox.ClientID%>").is(":checked")) {
                    //$("[name*='DuodenumNormalCheckBox']").prop('checked', true);
                }
        ...
        <% '---------------------------------------------------- DOCUMENT READY ------------------------------------------------------------- %>
            ...
            <%'--------------------- ERCP --------------------- %>
            <% If procTypeID = 2 Or procTypeID = 7 Then%>
                ...
                $('#PancreasTable input[type=checkbox]').change(function () {
                    $('#PancreasTable input[type=checkbox]').not("[id*='" + this.id + "']").prop('checked', false);
                });
        ...
        <telerik:RadPane ID="ControlsRadPane" runat="server" Height="505px" Scrolling="Y">
            <div id="ContentDiv">
                <div class="otherDataHeading">
                    <b>
                        <asp:Label ID="PageTitleHeading" runat="server">Normal Procedure</asp:Label></b>
                </div>
                <div style="margin: 5px 10px;">
                    ...
                    <div style="margin-left: 10px;">
                        ...
                        <telerik:RadTabStrip ID="RadTabStrip1" runat="server" MultiPageID="RadMultiPage1" ReorderTabsOnSelect="true" Skin="WebBlue" ForeColor="red"
                        ...
                        <telerik:RadMultiPage ID="RadMultiPage1" runat="server" SelectedIndex="0">
                            ...
                            <telerik:RadPageView ID="RadPageView5" runat="server">
                                ...
                                <fieldset id="ERCP_DuodenumFieldset" runat="server" visible="false">
                                    <legend>Duodenum</legend>
                                ...
                                <fieldset>
                                    ...
                                    <telerik:RadTabStrip ID="RadTabStrip2" runat="server" MultiPageID="RadMultipageE" ReorderTabsOnSelect="true" Skin="WebBlue" Orientation="HorizontalTop" Visible="false">
                                        <Tabs>
                                        ...
                                        <telerik:RadPageView ID="RadPageViewE0" Selected="true" runat="server">
                                            <div id="RadPageViewE0Div" class="multiPageDivTab">
                                                <fieldset>
                                                    <legend>Duodenum</legend>
                                                    <div>
                                                        <div id="divERCPAbnoDiagnosesDuodenum" runat="server" visible="false" class="inferredDiag" style="margin-bottom: 10px;"></div>
                                                    </div>
                                                ...
                                                <fieldset>
                                                    <legend>Biliary</legend>
                                                    <div>
                                                        <div id="divERCPBiliary" runat="server" visible="false" class="inferredDiag" style="margin-bottom: 6px;"></div>
                                                    </div>
                                                    <table id="BiliaryTable2">
                                                        <tr>
                                                            <td>
                                                            ...
                                                            <%-- <td>
                                                                <asp:CheckBox ID="BiliaryNotEnteredCheckBox" runat="server" Text="Not entered" Font-Bold="true" />
                                                                BiliaryNotEnteredCheckBox
                                                            </td>--%>
                                                        </tr>
                                                    </table>
                                                </fieldset>
                                                <fieldset>
                                                    ...
                                                    <table id="PapillaeTable">
                                                        <tr>
                                                            <td>
                                                                <asp:CheckBox ID="D33P2_CheckBox" runat="server" Text="Normal" /></td>
                                                            <%--  <td>
                                                                <asp:CheckBox ID="PapillaeNotEnteredCheckBox" runat="server" Text="Not entered" /></td>--%>
                                                            <%-- PapillaeNormalCheckBox--%>
                                                            <td style="padding-left: 10px; vertical-align: top;">
                                                                <asp:CheckBox ID="D41P2_CheckBox" runat="server" Text="Stenosed" Visible="false" />
                                                                <%-- StenosedCheckBox--%>
                                                            </td>
                                                ...
                                                <fieldset>
                                                    ...
                                                    <table id="PancreasTable">
                                                        <tr>
                                                            <td>
                                                                <asp:CheckBox ID="D67P2_CheckBox" runat="server" Text="Normal" />
                                                                <%-- PancreasNormalCheckBox--%>
                                                            </td>
                                                            <td>
                                                                <asp:CheckBox ID="D66P2_CheckBox" runat="server" Text="Not entered" />
                                                                <%-- PancreasNormalCheckBox--%>
                                                            </td>


                                                            <td>
                                                                <asp:CheckBox ID="D68P2_CheckBox" runat="server" Text="Annulare" Visible="false" />
                                                                <%-- AnnulareCheckBox--%>
                                                            </td>
                                                            <td>
                                                                <asp:CheckBox ID="D69P2_CheckBox" runat="server" Text="Duct injury" Visible="false" />
                                                                <%-- DuctInjuryCheckBox--%>
                                                            </td>
                                                            <td>
                                                                <asp:CheckBox ID="D74P2_CheckBox" runat="server" Text="Stent occlusion" Visible="false" />
                                                                <%-- PanStentOcclusionCheckBox--%>
                                                            </td>
                                                            <td>
                                                                <asp:CheckBox ID="D75P2_CheckBox" runat="server" Text="IPMT" Visible="false" />
                                                                <%-- IPMTCheckBox--%>
                                                            </td>
                                                        </tr>

                                                        <tr class="PancreasClass">
                                                            <td colspan="6" style="padding-top: 10px; display: none;">
                                                                <label style="padding-right: 10px; vertical-align: top;">Other</label>
                                                                <asp:TextBox ID="PancreaticOtherTextBox" runat="server" style="width:500px; height:50px; " Width="500px" Height="50px" TextMode="MultiLine" />
                                                            </td>
                                                        </tr>
                                                    </table>
                                    ...
                                    <div style="padding-top: 10px" runat="server" visible="false">
