...
Partial Class Products_Gastro_Abnormalities_Common_Diagnoses
...
Protected Shared procTypeID As Integer
    ...
    Private Sub PopulateGastroData(sPP_Diagnoses As String, da As OtherData, iProcID As Integer)
        If sPP_Diagnoses <> "" Then
            ...
            Dim sDiag As String() = sPP_Diagnoses.Split(delim, StringSplitOptions.None)
            For Each Diag In sDiag
                If Diag.Contains("Duodenum: </b>") Then
                    ...
                    End If
                End If
                If Diag.Contains("Stomach: </b>") Then
                    ...
                    End If
                End If
                If Diag.Contains("Oesophagus: </b>") Then
            ...
            For Each Diag In sDiag
                If Diag.Contains("Duodenum: </b>") Then
                    ...
                    If Not chkAbnoDiagnoses(Diag) Then '### Not ('not entered'/'normal')
                        ...
                        divERCPAbnoDiagnosesDuodenum.InnerHtml = "<b>" & Diag ' Left(Diag, 1).ToUpper & Diag.Substring(1)
                    Else
                ...
                If Diag.Contains("Ampulla: </b>") Then
                ...
                If Diag.Contains("Pancreas: </b>") Then
                ...
                If Diag.Contains("Biliary: </b>") Then
    ...
    Private Sub setERCPValue(ctrl As Control, drDg As DataTable)
        ...
        ElseIf TypeOf ctrl Is TextBox Then
            ...
            If a0Value IsNot Nothing AndAlso Not IsDBNull(a0Value.Item("Value")) AndAlso CStr(a0Value.Item("Value")).Trim <> "" Then
                DirectCast(ctrl, TextBox).Text = a0Value.Item("Value")
            End If
    ...
    Private Sub SaveGastroData()
        ...
        For Each listCtrl As Control In DuodenumDataList.Controls
            ...
            End If
        Next
        'da.SaveUpperGIDiagnoses(CInt(Session(Constants.SESSION_PROCEDURE_ID)), _
        '                                OverallNormalCheckBox.Checked, _
        '                                OesophagusNormalCheckBox.Checked, _
        '                                OesophagusNotEnteredCheckBox.Checked, _
        '                                OesoList, _
        '                                StomachNotEnteredCheckBox.Checked, _
        '                                StomachNormalCheckBox.Checked, _
        '                                StomachList, _
        '                                DuodenumNotEnteredCheckBox.Checked, _
        '                                Duodenum2ndPartNotEnteredCheckBox.Checked, _
        '                                DuodenumNormalCheckBox.Checked, _
        '                                DuoList, _
        '                                OesophagusOtherDiagnosisTextBox.Text, _
        '                                StomachOtherDiagnosisTextBox.Text, _
    ...
    Private Sub SaveERCPData()
        ...
        Dim PancreasNotEnteredCheckBox As Boolean = false
    ...
    'End Sub
    Sub ExitForm()
        ScriptManager.RegisterStartupScript(Me, Page.GetType, "ScriptRefreshParent", "CloseWindow();", True)
    End Sub
End Class