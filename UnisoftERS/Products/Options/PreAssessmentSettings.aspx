<%@ Page Language="VB" AutoEventWireup="false" Inherits="UnisoftERS.Products_Options_PreAssessmentSettings"
    CodeBehind="PreAssessmentSettings.aspx.vb" %>
...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <asp:ObjectDataSource ID="SectionsObjectDataSource" runat="server" SelectMethod="GetSectionList" TypeName="UnisoftERS.Options"></asp:ObjectDataSource>
        <asp:ObjectDataSource ID="QuestionsObjectDataSource" runat="server" SelectMethod="GetQuestionList" TypeName="UnisoftERS.Options"></asp:ObjectDataSource>
