<%@ Page Language="VB" AutoEventWireup="false" Inherits="UnisoftERS.Products_Options_NurseSettings"
    CodeBehind="NurseSettings.aspx.vb" %>
...
<head runat="server">
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script type="text/javascript">
            ...
            function openAddItemWindow(itemId, itemName, sortOrder, procedureType)
            {
                var oWnd = $find("<%= AddNewItemRadWindow.ClientID%>");
                var procedureDropdown = $find("<%=NurseModuleProcedureTypeRadComboBox.ClientID%>");
                ...
                if (itemId > 0) {
                    ...
                    var selectedProcedureItem = procedureDropdown.findItemByValue(procedureType);
                    if (selectedProcedureItem) {
                        selectedProcedureItem.select();
                    }
                }
                else
                {
                    var items = procedureDropdown.get_items();
                                    ...
                                    <MasterTableView ShowHeadersWhenNoRecords="true" ClientDataKeyNames="SectionId">
                                        ...
                                        <Columns>
                                            ...
                                            <telerik:GridBoundColumn UniqueName="SectionName" DataField="SectionName" HeaderText="SectionName" SortExpression="SectionName" HeaderStyle-Width="320px"></telerik:GridBoundColumn>
                                             <telerik:GridBoundColumn UniqueName="ProcedureTypeName" DataField="ProcedureTypeName" HeaderText="ProcedureTypeName" SortExpression="ProcedureTypeName" HeaderStyle-Width="320px"></telerik:GridBoundColumn>
                ...
                <telerik:RadWindowManager ID="AddNewItemRadWindowManager" runat="server" ShowContentDuringLoad="false"
                    ...
                    <Windows>
                        <telerik:RadWindow ID="AddNewItemRadWindow" runat="server" ReloadOnShow="true" Title="New Item"
                            KeepInScreenBounds="true" Width="370px" Height="225px" VisibleStatusbar="false" ShowContentDuringLoad="true">
                            <ContentTemplate>
                                <table cellspacing="3" cellpadding="3">
                                    ...
                                    <tr>
                                     ...
                                     <tr>
                                        ...
                                        <td style="width: 65%;">
                                            <telerik:RadComboBox ID="NurseModuleProcedureTypeRadComboBox" DataTextField="ProcedureType" runat="server" DataValueField="ProcedureTypeId"  />
                                        </td>
                                     </tr>
                                    <tr>
