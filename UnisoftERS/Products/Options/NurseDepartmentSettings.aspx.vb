...
Partial Class Products_Options_NurseDepartmentmentSettings
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        Protected Sub AddNewItemSaveRadButton_Click(sender As Object, e As EventArgs) Handles AddNewItemSaveRadButton.Click
            ...
            da.UpdateNurseModuleSectionList(CInt(hiddenItemId.Value), AddNewItemRadTextBox.Text, sortOrder, Nothing)
            SectionRadGrid.Rebind()
            ElseIf AddNewItemRadTextBox.Text <> "" Then
            newItemId = da.InsertNurseModuleSectionsItem(AddNewItemRadTextBox.Text, sortOrder)
