<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Templates/Unisoft.master" CodeBehind="IndicationsManagement.aspx.vb" Inherits="UnisoftERS.IndicationsManagement" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="BodyContentPlaceHolder" runat="server">
    ...
    <div style="height:750px; overflow:auto">
        <asp:Repeater ID="rptIndicationsConfig" runat="server" OnItemCommand="rptIndicationsConfig_ItemCommand">
            <HeaderTemplate>
            ...
            <ItemTemplate>
                <tr>
                    <td><asp:HiddenField ID="IndicationIdHiddenField" runat="server" Value='<%#Eval("UniqueId") %>' /><telerik:RadTextBox ID="DescriptionRadTextBox" runat="server" Text='<%# Eval("Description") %>' /></td>
                    ...
                    <td>
                        <telerik:RadButton ID="SaveIndicationRadButton" runat="server" Text="Save" CommandName="Save" CommandArgument='<%#Eval("UniqueId") %>' /></td>
                </tr>
            </ItemTemplate>
            <FooterTemplate>
                </tbody>
