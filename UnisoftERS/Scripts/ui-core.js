...
new function () {
    ...
    window.UiCore = {
        ...
        createShaper: function (shape, z, layer) {
            if (document.getElementById("lblMarking").innerHTML == "Enabled") {

                if (document.getElementById("lblStatus").innerHTML == "Site") {
                    document.getElementById("lblMarking").innerHTML = "Disabled"
                }
